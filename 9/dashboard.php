...
if ($result_role->num_rows > 0) {
    ...
    // Если пользователь — администратор, показываем список всех пользователей
    if ($user_role === 'admin') {
...
<body>
    ...
    <script>
        function editUser(userId) {
            ...
            // Отправляем форму редактирования на сервер
        ...
        function confirmDelete(userId) {
            ...
            if (confirmDelete) {
                // Отправляем запрос на удаление пользователя на сервер
        ...
        function showAddUserForm() {
            // Здесь вы можете добавить логику для отображения формы добавления нового пользователя
            ...
            // Создаем input для имени пользователя
            var usernameInput = document.createElement("input");
            usernameInput.type = "text";
            usernameInput.name = "username";
            usernameInput.value = username;

            // Создаем input для пароля
